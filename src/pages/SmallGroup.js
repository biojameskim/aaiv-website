  ...
  return <div className="main-container">
    ...
    <div className={`sg-leaders-section ${isMobile ? 'sg-leaders-section-mobile' : ''}`}>
      <div className="text-container">
        ...
        <p>Guided by one or two of our amazing and friendly small group leaders, you can share life and explore God together in weekly meetings centered around a Bible study, which are often preceded by a small group dinner. Whether you’ve grown up in church your whole life or are just starting to question if there could be a God who has created all things, you are invited to come check out a small group as we cover the book of 1 Corinthians! Click on a small group leader to learn more!</p>
      </div>
      ...
      <div className="sg-modals">
        ...
        >
          <div>
            <Profile image={mon_prof} title={'Melody Xu'} text={'Mondays 7:30pm @ Uris Hall 262 (bring-your-own-dinner @ 7pm)'} email={'myx2@cornell.edu'} />
            <Question
              isMobile={isMobile}
              image={mon_prof}
              question={"Fast Facts"}
